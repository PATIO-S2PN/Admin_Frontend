      ...
      <div className='w-full max-w-md'>
        <form onSubmit={handleSignUp} className='space-y-4'>
          ...
          <div>
            ...
            <select className='w-full px-3 py-2 text-sm leading-tight text-gray-900 border rounded shadow appearance-none focus:outline-none focus:shadow-outline font-roboto bg-orange-50 hover:shadow-lg' name="role" value={userDetails.role} onChange={handleChange}>
