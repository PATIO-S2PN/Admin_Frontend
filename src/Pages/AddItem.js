...
const Navbar = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="p-9 w-full h-auto bg-gray-200">
        ...
        <div className="absolute top-[SIZE OF ORGANIZE BOX] right-10 mt-4 mr-4 ">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="display-images">
            Display Images
          </label>
          <input className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100" id="display-images" type="file" onChange={handleImageChange} />
          {imagePreview && (
            <div className="mt-4">
        ...
        <div class="relative bg-gray-300 rounded-lg shadow-lg p-6 w-full max-w-4xl">
  <div class="flex flex-wrap -mx-3">
    ...
    <div class="w-full md:w-1/2 px-10">
      ...
      <button class="mt-4 bg-gray-500 hover:bg-black text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
        Add another option
      </button>
    </div>
  </div>
        ...
        <div class="flex justify-center w-1/2 items-center mt-10 space-x-10 p-4">
