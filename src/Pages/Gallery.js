      ...
      <form onSubmit={editingIndex !== null ? handleUpdatePhoto : handleAddPhotos}>
        <div className="flex flex-col items-start mb-4 sm:flex-row sm:items-center">
          <input 
            ...
            className="px-4 py-2 mb-2 bg-orange-200 border rounded-md sm:mb-0 sm:mr-4 w-full sm:w-auto"
          />
          <input 
            type="text"
            placeholder="Name"
          ...
          <button 
            type="submit" 
            className="px-4 py-2 text-white bg-orange-900 rounded-md hover:bg-orange-700 w-full sm:w-auto"
            disabled={uploading}>
