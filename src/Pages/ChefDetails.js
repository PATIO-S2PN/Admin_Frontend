  ...
  return (
    <div className="w-full h-auto bg-white p-9">
      <div className="flex justify-between items-center">
        <h1 className="text-4xl text-orange-800 font-semibold">Chef Details</h1>
        ...
        <div className="w-1/2 basis-full md:basis-auto md:flex md:items-center">
          <div className="relative w-full">
            ...
            <input type="text" placeholder="Search " className="w-full pl-10 py-2 px-4 bg-orange-200 border rounded-lg" />
          </div>
        </div>
        <button 
          onClick={() => navigate('/chef')} 
          className="py-2 px-8 bg-orange-900 text-white rounded-md hover:bg-orange-600">
          Add Chef
        </button>
      </div>
      {chefs.length > 0 ? (
        chefs.map((chef, index) => {
          ...
          return (
            <div key={index} className="max-w-lg mx-auto p-8 bg-orange-100 shadow-md rounded-lg mt-10">
