...
const NotificationItem = ({ notification, onToggleReadStatus }) => {
    return (
        <div className={`p-4 mb-3 bg-orange-100 rounded shadow ${notification.read ? 'bg-gray-300' : ''}`}>
            <div className="flex justify-between items-center">
                <div className="flex-grow">
                    ...
                    <Link to={notification.link} className="text-orange-600 px-5 hover:text-blue-800 inline-block mt-2">
                        View details
                    </Link>
                </div>
                <button
